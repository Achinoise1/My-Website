# Did not attempt to load JSON data

:::info
完整报错：Did not attempt to load JSON data because the request Content-Type was not ‘application/json’
:::
